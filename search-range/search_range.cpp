...
/**
 * @brief Solution class providing methods to find the first and last positions of a
 *        target value in a sorted integer array.
 *
...
public:
    ...
    /**
     * @brief Returns a vector containing the first and last positions of `target`.
     *
